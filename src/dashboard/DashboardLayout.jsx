...
const sidebarLinks = [
  ...
  { to: "/dashboard/live", label: "Live onboarding", adminOnly: true },
...
export default function DashboardLayout() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.surface, position: "relative", display: "flex", flexDirection: "column" }}>
      ...
      `}</style>
      {/* Top bar — dashboard own header, not website header */}
      <header style={{
        position: "relative",
        zIndex: 1,
        height: 64,
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <button
            ...
            style={{
              ...
              background: "transparent", color: C.cream, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18,
            }}
          >
            ≡
          </button>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <button
            ...
            style={{
              fontFamily: font.body, fontSize: 12, fontWeight: 500, color: C.mute, background: "transparent", border: `1px solid ${C.border}`,

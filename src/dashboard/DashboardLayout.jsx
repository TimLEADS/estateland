...
const sidebarLinks = [
  ...
  { to: "/dashboard/email", label: "\u{1F4E7} Email Center", adminOnly: true },
    ...
    <div style={{ minHeight: "100vh", background: C.surface, position: "relative", display: "flex", flexDirection: "column" }}>
      ...
      <header style={{ position: "relative", zIndex: 1, height: 64, background: "rgba(8,8,8,0.85)", backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", borderBottom: `1px solid ${C.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <button type="button" onClick={() => setSidebarOpen((o) => !o)} aria-label="Toggle sidebar" style={{ width: 40, height: 40, borderRadius: 8, border: `1px solid ${C.border}`, background: "transparent", color: C.cream, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}>&#9776;</button>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <button type="button" onClick={handleLogout} style={{ fontFamily: font.body, fontSize: 12, fontWeight: 500, color: C.mute, background: "transparent", border: `1px solid ${C.border}`, padding: "8px 16px", borderRadius: 8, cursor: "pointer" }}>Log out</button>
        </div>
      </header>

  ...
  return (
    <div>
      ...
      {showForm && (
        ...
        >
          <h2
            style={{ fontFamily: font.body, fontSize: 16, fontWeight: 600, color: T.text, marginBottom: 20 }}
          >
            New realtor
          </h2>
          <form
              ...
              <div>
                ...
                <div style={{ marginTop: 10 }}>
                  {editingPassword === u.id ? (
                    ...
                    <button
                      type="button"
                      onClick={() => { setEditingPassword(u.id); setNewPassword(u.password || ""); }}
                      style={{
                        fontFamily: font.body,
                        fontSize: 11,
                        color: u.password ? "#22c55e" : C.gold,
                        background: "transparent",
                        border: `1px solid ${u.password ? "rgba(34,197,94,0.4)" : C.gold}`,
                        padding: "5px 10px",
                        borderRadius: 6,
                        cursor: "pointer",
                      }}
                    >
                      {u.password ? "✓ Password set — change" : "⚠ Set login password"}
                    </button>
                  )}
                </div>
              </div>
